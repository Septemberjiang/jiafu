<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="参数名" prop="parameter_name" align="center" :class-name="getSortClass('id')">
        <template slot-scope="{row}">
          <span>{{ row.parameter_name }}</span>
        </template>
      </el-table-column>
      <el-table-column label="参数值" prop="parameter_value" align="center" :class-name="getSortClass('id')">
        <template slot-scope="{row}">
          <span>{{ row.parameter_value }}</span>
        </template>
      </el-table-column>
      <el-table-column label="备注" prop="remark" align="center" :class-name="getSortClass('id')">
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="auto" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="参数名" prop="parameter_name">
          <el-input v-model="temp.parameter_name" />
        </el-form-item>
        <el-form-item label="参数值" prop="parameter_value">
          <el-input v-model="temp.parameter_value" />
        </el-form-item>
...
<script>
import { fetchList, fetchPv, createArticle, updateArticle } from '@/api/system/parameter/parameter'
